...
exports.exchangeRate = exports.scriptHistoryUnc = exports.scriptHistory = exports.getSpentOutput = exports.getTransaction = exports.listUnspentConfWOC = exports.listUnspentUnconfWOC = exports.listUnspent = exports.broadcast = exports.oracleWoC = void 0;
...
function oracleWoC(myURL) {
    return __awaiter(this, void 0, void 0, function () {
        var npools, url, resp, bcFinish, cycle, exchangePrice, result, e_1;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    cycle = 0;
                    _loop_1 = function () {
                        var resp_1, formData, response, e_2;
...
function listUnspent(addOrScriptHash, homenetwork) {
    return __awaiter(this, void 0, void 0, function () {
        var poolID, npools, UTXOconf, UTXOunconf, size1, utxos_1, i, i, urlAdress01, urlAdress02, url, resp, bcFinish, cycle, utxoScript, utxos, res, res_1, res, e_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    poolID = 0;
...
function listUnspentUnconfWOC(addOrScriptHash, homenetwork) {
    return __awaiter(this, void 0, void 0, function () {
        var poolID, npools, urlAdress01, url, resp, bcFinish, cycle, utxoScript, utxos, res, res_2, res, e_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    poolID = 0;
...
function listUnspentConfWOC(addOrScriptHash, homenetwork) {
    return __awaiter(this, void 0, void 0, function () {
        var poolID, npools, urlAdress01, url, resp, bcFinish, cycle, utxoScript, utxos, res, res_3, res, e_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    poolID = 0;
...
function getTransaction(txid, homenetwork) {
    return __awaiter(this, void 0, void 0, function () {
        var poolID, npools, urlAdress01, urlAdress02, url, resp, bcFinish, cycle, e_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    poolID = 0;
...
function getSpentOutput(txid, vout, homenetwork) {
    return __awaiter(this, void 0, void 0, function () {
        var poolID, npools, position, stxo, urlAdress01, url, resp, bcFinish, cycle, res, e_7;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    poolID = 0;
...
function scriptHistoryUnc(addOrScriptHash, homenetwork) {
    return __awaiter(this, void 0, void 0, function () {
        var poolID, npools, urlAdress01, urlAdress02, url, resp, bcFinish, cycle, utxoScript, utxos, res, index0, jsonSTR, res, res, e_9;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    poolID = 0;
...
function exchangeRate() {
    return __awaiter(this, void 0, void 0, function () {
        var npools, url, resp, bcFinish, cycle, exchangePrice, res, res, e_10;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    npools = 1 // somente WoC por enquanto
