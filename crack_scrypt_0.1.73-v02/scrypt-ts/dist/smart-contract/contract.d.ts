...
export declare class SmartContract {
   ...
   */
    ...
    */
    ...
    /** @ignore */
    private static handleSigResponses;
    /**
    ...
    */
    static multiContractCall(partialContractTx: ContractTransaction, feeSigner: Signer, options?: MultiContractCallOptions): Promise<MultiContractTransaction>;
    /**
     ...
     */
    getOffchainUpdates<T extends this>(): OffchainUpdates<T> | null;
}
export {};
