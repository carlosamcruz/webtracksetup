...
class Schnorr extends scrypt_ts_1.SmartContractLib {
    ...
    static verify(sig, pubKey, msg, R) {
        const r = sig.slice(0, 64); // First 32 bytes
        const s = (0, scrypt_ts_1.byteString2Int)((0, scrypt_ts_1.reverseByteString)(sig.slice(64, 128), 32n) + (0, scrypt_ts_1.toByteString)('00'));
        // e = Hash(r || P || msg)
