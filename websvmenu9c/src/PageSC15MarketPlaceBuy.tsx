...
import {payTXID} from './Page03ReadMarketPlace';
...
function PageSC15MarketPlaceBuy() {
//const  deployACT: FC = () => {  
  ...
  const interact = async (amount: any) => {
    ...
    if( payTXID.length === 64 )
    {
      ...
      try {
        ...
        tx = await provider.getTransaction(payTXID)  
...
export default PageSC15MarketPlaceBuy;
