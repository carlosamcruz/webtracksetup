...
const Page05P2PKC: FC = () => {
  ...
  */
  ...
  const createP2PK = async (amount: any) => {
    ...
    else
    {
      ...
      else
      {
        ...
        console.log("UTXO List: ", utxoListOpt)
      ...
      */
      ...
      let scriptP2PK = addarray + ' OP_CHECKSIG'
      ...
      */
      ...
      //for(let i =0; i < sendADD.length; i ++)
      {
        ...
        tx2.addOutput(new bsv.Transaction.Output({
            ...
            script: bsv.Script.fromASM(scriptP2PK),
              ...
              <div style={{ display: 'inline-block', textAlign: 'center', paddingBottom: '20px' }}>
                <label style={{ fontSize: '14px', paddingBottom: '5px' }}  
                    > 
                      ...
                      <input ref={addToSend} type="text" name="PVTKEY1" min="1" placeholder="SEC Public Key" />
                    </label>     
                </div>
      </div>
