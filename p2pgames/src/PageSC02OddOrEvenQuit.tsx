...
const PageSC02OddOrEvenQuit: FC<props1> = (props) => {
  ...
  const writeToChain = async (amount: any) => {
    ...
    else
    {
      ...
      instance2.bindTxBuilder('quitGame', async function () {
        ...
        //Pode ser abandonado no bloco atual?
        //Pois deve acontecer até o timelock do contrato
        //Desta forma o contrato poderia en tese ser encerrado no mesmo bloco da sua criação
        //mas por algum motivo a blockhain recusa, então devemos colocar no minimo o mesmo bloco do contrato.
      ...
      const { tx: callTx } = await instance2.methods.quitGame(
