...
export async function chainInfoWoC(isMain: boolean): Promise <any>
{
  ...
  while(!bcFinish && cycle < npools * 2)
  {
      ...
      url = new URL('https://api.whatsonchain.com/v1/bsv/main/chain/info')

      if(!isMain)
        url = new URL('https://api.whatsonchain.com/v1/bsv/test/chain/info')
